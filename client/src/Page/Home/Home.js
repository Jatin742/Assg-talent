      ...
      <div className="px-4 pt-5 my-5 text-center border-bottom">
        ...
        <div className="col-lg-6 mx-auto">
          ...
          <div className="d-grid gap-2 d-sm-flex justify-content-sm-center mb-5">
            <button type="button" className="btn btn-dark btn-lg px-4 me-sm-3">Get a Quote</button>
        ...
        <div className="row g-4 py-5 row-cols-1 row-cols-lg-3">
          <div className="feature col">
            ...
            <a href="#" className="text-dark">
              Get a quote
              <img src={chevronright} alt="" className='text-dark'/>
          ...
          <div className="feature col">
            <div className="feature-icon d-inline-flex align-items-center justify-content-center text-bg-dark bg-gradient fs-2 mb-3">
              ...
              <img src={chatsquare} alt="" height="30px" className='text-bg-dark' />
            </div>
